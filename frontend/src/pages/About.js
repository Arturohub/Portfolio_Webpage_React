...
const gallery = [
    ...
    {src: img4, description: 'Title: "We believe". I found my home also thanks to my girlfriend, who is not just the most amazing person in the world, but also the most caring, loving, beautiful, smart, artistic, compasionate... fun fact, Calahonda in the background '},
